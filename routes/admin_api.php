...
use Illuminate\Support\Facades\Route;
    ...
    Route::post('/user/discount/create', [AdminApiController::class, 'insert_user_discount'])->name('new_user_discount_api');
    Route::post('/user/discount/delete', [AdminApiController::class, 'delete_user_discount'])->name('delete_user_discount_api');
