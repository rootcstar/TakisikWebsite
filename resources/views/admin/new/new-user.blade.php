            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h5 class="card-subtitle"> Yeni kullanıcı oluşturabilirsiniz</h5>
                        <form class="row g-3 needs-validation" id="form" novalidate>
                            <div class="col-md-6 form-group">
                                <div class="form-floating">
                                    <label for="title">{{LanguageChange('Company Name')}}</label>
                                    <input type="title" class="form-control input-fields" id="company_name" placeholder="Lütfen doldurunuz"  pattern="[a-zA-Z0-9ğüşöçĞÜŞÖÇİ]{1,30}" required>
