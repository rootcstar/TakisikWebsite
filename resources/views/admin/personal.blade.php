        ...
        <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="info-tab" data-toggle="pill"
                   href="#infotab" role="tab" aria-controls="info" onclick="ShowTable('{{encrypt('v_personal_accounts')}}')"
                   aria-selected="true">Müşteri Kimlik Bilgisi</a>
            </li>
            <li class="nav-item">
                <a class="nav-link " id="billing-tab" data-toggle="pill"
                   href="#billingtab" role="tab" aria-controls="billing" onclick="ShowTable('{{encrypt('users_personel')}}')"
                   aria-selected="true">Müşteri Fatura Adres Bilgisi</a>
            </li>
            <li class="nav-item">
                <a class="nav-link " id="shipping-tab" data-toggle="pill"
                   href="#shippingtab" role="tab" aria-controls="shipping" onclick="ShowTable('{{encrypt('v_personal_shipping_addresses')}}')"
                   aria-selected="true">Müşteri Teslimat Adres Bilgisi</a>
            </li>
            <li class="nav-item">
                <a class="nav-link " id="cards-tab" data-toggle="pill"
                   href="#cardstab" role="tab" aria-controls="cards" onclick="ShowTable('{{encrypt('v_personal_cards')}}')"
